...
double find_3G(double *a)   
{
    ...
    double H3[]={M_PI*(-4.+3*sqrt(2.*M_PI*a[0]))/(4.*a[0]), 
        ...
        -2.*M_PI*(a[2]*sqrt(a[0]+a[2])+a[0]*(-3.*sqrt(M_PI)*a[2]+sqrt(a[0]+a[2])))/(pow(a[0]+a[2],2.5)),
        -2.*M_PI*(a[2]*sqrt(a[1]+a[2])+a[1]*(-3.*sqrt(M_PI)*a[2]+sqrt(a[1]+a[2])))/(pow(a[1]+a[2],2.5)),
        M_PI*(-4.+3*sqrt(2.*M_PI*a[2]))/(4.*a[2])
        };
...
{ 
    ...
    double H3[]={M_PI*(-4.+3*sqrt(2.*M_PI*a1t))/(4.*a1t), 
        ...
        -2.*M_PI*(a3t*sqrt(a2t+a3t)+a2t*(-3.*sqrt(M_PI)*a3t+sqrt(a2t+a3t)))/(pow(a2t+a3t,2.5)),
        -2.*M_PI*(a3t*sqrt(a1t+a3t)+a1t*(-3.*sqrt(M_PI)*a3t+sqrt(a1t+a3t)))/(pow(a1t+a3t,2.5)),
        -2.*M_PI*(a3t*sqrt(a2t+a3t)+a2t*(-3.*sqrt(M_PI)*a2t+sqrt(a2t+a3t)))/(pow(a2t+a3t,2.5)),
        M_PI*(-4.+3*sqrt(2.*M_PI*a3t))/(4.*a3t)
    };
